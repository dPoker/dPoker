"""
Standard JSON structure for dpoker poker hands.
...
# Example hand encoded in the dpoker canonical JSON structure.
...
def from_standard_json(payload: Mapping[str, Any]) -> HandHistory:
    """
    Convert a structured dpoker hand JSON payload into a HandHistory object.
    """
