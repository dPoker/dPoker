...
Validates that hands under poker44/hands_generator/bot_hands/bot_hands.json and
poker44/hands_generator/human_hands/human_hands.json match the schema in poker44/core/hand_json.py.
"""
