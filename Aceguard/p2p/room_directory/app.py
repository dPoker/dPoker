...
from Aceguard.p2p.crypto import hmac_verify
from Aceguard.p2p.schemas import RoomListing, ValidatorAnnounce
from Aceguard.p2p.room_directory.storage import InMemoryDirectory


DIRECTORY_SHARED_SECRET = os.getenv("DIRECTORY_SHARED_SECRET", "dev-secret")
TTL_SECONDS = int(os.getenv("DIRECTORY_TTL_SECONDS", "60"))

app = FastAPI(title="dPoker Room Directory", version="0.1.0")
